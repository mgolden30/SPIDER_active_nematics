addpath('../bin')
fprintf('Starting vector regression with curl... (momentum library)\n');
...
function vals = gpu_integrate_vector_curl( U, V, dx_vec, corners, size_vec, m, n, mask )
  ...
  vals =        gpu_integrate_data( U, [1], dx_vec, corners, size_vec, m, n, mask );
...
function vals = gpu_integrate_stress_tensor( s_xx, s_xy, s_yx, s_yy, dx_vec, corners, size_vec, m, n, mask )
  ...
  vals =        gpu_integrate_data( s_xx - s_yy, [2,1], dx_vec, corners, size_vec, m, n, mask );
